            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        resultado = _a.sent();
                        mongo.cerrarCliente(cliente);
                        return [2 /*return*/, resultado.value || __assign({ _id: resultado.lastErrorObject.upserted }, hotel)];
                }
            });
        });
    };
    Hotel.buscarHotelPorId = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var _id, cliente, hotel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!id)
                            throw { codigo: 400, mensajeDesarrollador: "No puede obtenerse el hotel, id nulo." };
                        _id = new mongodb_1.ObjectID(id);
                        return [4 /*yield*/, mongo.obtenerCliente()];
                    case 1:
                        cliente = _a.sent();
                        return [4 /*yield*/, cliente.db().collection("hoteles").find({ _id: _id }).next()];
                    case 2:
                        hotel = _a.sent();
                        mongo.cerrarCliente(cliente);
